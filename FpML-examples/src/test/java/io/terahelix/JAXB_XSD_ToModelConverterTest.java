...
public class JAXB_XSD_ToModelConverterTest
{
	...
	{
		final JAXB_XSDInstances_Model model = outputReports("../westpac-model/codelist/fpml/src/main/resources/");
	...
	{
		final JAXB_XSDInstances_Model model = outputReports("../westpac-model/confirmation/fpml/src/main/resources/");
	...
	{
		Path root = Paths.get("../westpac-model/confirmation/fpml/src/main/resources/");
